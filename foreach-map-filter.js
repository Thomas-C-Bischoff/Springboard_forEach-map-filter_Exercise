...
function vowelCount(str)
{
    ...
    lowercase.forEach(function(letter)
    {
        ...
        {
            if (vowelAmount[letter])
            {
                vowelAmount[letter] += 1;
            }
            else
            {
                vowelAmount[letter] = 1;
...
{
    const extracted = arr.map(function(name)
    {
        return name[key];
    });
    return extracted;
...
function removeVowels(str)
{
    ...
    const noVowels = letters.filter(function(letter)
    {
...
function doubleOddNumbers(arr)
{
    ...
    const doubledOdds = odds.map(function(val)
    {
        return val * 2;
    });
    return doubledOdds;
